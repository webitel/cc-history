export default {
  ...
  dashboards: {
    ...
    callsByPeriod: {
      ...
      description: 'Отображает количество звонков с учётом выбранной фильтрации за выбраный период',
    },
    callsCount: {
    ...
    callsCountMetric: {
      ...
      description: 'Отображает числовые значения количества звонков, в которых прошло и не прошло соединение с учётом выбранной фильтрации за выбраный период ',
    },
    callsCountVariable: {
      title: 'Количество звонков (variables)',
      description: 'Отображает количество звонков по вариантам введённой переменной с учётом выбранной фильтрации за выбраный период',
    },
    callsDuration: {
      title: 'Длительность звонков',
      description: 'Группирует общую длительность звонков (по полю duration) с учётом выбранной фильтрации за выбраный период',
    },
    callsDurationMetric: {
      title: 'Длительность звонков (метрика)',
      description: 'Отображает длительность звонков, в которых прошло и не прошло соединение с учётом выбранной фильтрации за выбраный период ',
    },
  },
  fields: {
    agent: 'Агент',
