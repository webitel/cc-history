...
export default {
	...
	export: {
		audioRecording: 'Аудіозапис | Аудіозаписи',
		videoRecording: 'Відеозапис | Відеозаписи',
		screenRecording: 'Запис екрану | Записи екрану',
	...
	registry: {
		...
		call: {
			...
			videoCallRecording: 'Запис відеодзвінка',
			chatHistory: 'Історія чату',
			videoFile: 'Відеофайл',
			noVideoFile: 'Тут немає відеофайлу',
