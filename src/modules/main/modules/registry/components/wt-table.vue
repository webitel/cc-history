      ...
      >
        ...
        >
          <slot
            ...
            :name="col.value"
          >
            <div>{{ getPropertyValue(row, col.value) }}</div>
          </slot>
        </td>
...
import getNextSortOrder from '@webitel/ui-sdk/src/components/wt-table/_internals/getSortOrder';
...
export default {
  ...
  methods: {
    //TODO: delete whole file and use wt-table from ui-sdk, but add getProlertyValue method firstly
